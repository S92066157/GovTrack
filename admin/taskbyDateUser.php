  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12 my-2">
        <h3 class="text-white text-center">Task by Date and User</h3>
      </div>
    </div>

    <div class="row">
      <div class="col-sm-8 col-xs-8 col-md-4 col-lg-10 mx-auto text-center">
        ...
        <form id="searchTask" method="POST" action="">
          <div class="d-flex align-items-center mb-2 mt-1 firstrow">
            ...
            <select class="form-select" style="margin-right: 10px;" name="username" id="username">
            ...
            <input type="button" class="btn btn-primary" onclick="loadtaskbyUserDate()" value="SEARCH">
